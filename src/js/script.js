...

{
  ...
  class CartProduct{
    ...
    getData(){
      ...
      cartDataProduct.id = thisCartProduct.id;
      cartDataProduct.amount = thisCartProduct.amount;
      cartDataProduct.price = thisCartProduct.price;
      cartDataProduct.priceSingle = thisCartProduct.priceSingle;
      cartDataProduct.name = thisCartProduct.name;
      cartDataProduct.params = thisCartProduct.params;
